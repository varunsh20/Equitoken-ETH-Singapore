import {Box,Flex,HStack,Button,Select,Text,Image,Input,InputGroup,InputLeftElement,Spinner,Center} from '@chakra-ui/react';
...
export default function Buy(){
    ...
    //         const readContract = new ethers.Contract(selectedTokenAddress,tokenContractsABI,rpcProvider);
    //         const balWei = await readContract.balanceOf("0x62980c22d2ee90E11768F57450EdB329535546EA");
    //         const balUnits = ethers.utils.formatUnits(balWei,18);
    //         console.log(balUnits);
    //         setBalance(balUnits);
    //     }
    //     getUserBalance();  
    // },[balance])
    ...
    const buyTokens = async()=>{
        ...
        if(selectedTokenAddress==null || selectedTokenAddress==""){
            ...
            const writeContract = new ethers.Contract(selectedTokenAddress,tokenContractsABI,provider.getSigner());
    ...
    const sellTokens = async()=>{
        ...
        if(selectedTokenAddress==null || selectedTokenAddress==""){
            ...
            const usdcContract = new ethers.Contract(usdcAddress,erc20ABI,provider.getSigner());
            const buyAmount = ethers.utils.parseUnits(amount,8);
            const tx = await writeContract.sendRedeemRequest(buyAmount);
            await tx.wait()
            .then( () => {
            ...
            <Flex alignItems="center" justifyContent="center" w="100%" ml="500px">
                ...
                border="solid 0.9px #253350" borderRadius={"25px"}  zIndex={2} mb="10px">
                    ...
                    <Box p="20px">
                        ...
                        cursor:"pointer"}} onClick={sellTokens}>
                        Sell Tokens
                    </Button>
                    </Box>
                </Box>
